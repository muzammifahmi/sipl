                    ...
                    <form action="{{ route('barang.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-slate-500">Harus unik, tidak boleh sama dengan alat lain.</p>
                                @error('kode_barang')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <select id="kategori" name="kategori" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                                    ...
                                    <option value="Pecah Belah" {{ old('kategori') == 'Pecah Belah' ? 'selected' : '' }}>Gelas / Pecah Belah</option>
                                    <option value="Bahan Kimia" {{ old('kategori') == 'Bahan Kimia' ? 'selected' : '' }}>Bahan Kimia</option>
                                    <option value="Mekanik" {{ old('kategori') == 'Mekanik' ? 'selected' : '' }}>Perkakas Mekanik</option>
                            ...
                            <div>
                                ...
                                <input type="number" name="stok_total" id="stok_total" min="1" value="{{ old('stok_total', 1) }}" required
                                ...
                                <p class="mt-1 text-xs text-slate-500">Stok Tersedia otomatis sama dengan Stok Awal.</p>
                            </div>
